...
1.  **Regra 1:** Qualquer ponto além de 3σ (limites de controle).
2.  **Regra 2:** 9 pontos consecutivos do mesmo lado da linha central.
3.  **Regra 3:** 2 de 3 pontos consecutivos além de 2σ (na mesma zona).
4.  **Regra 4:** 4 de 5 pontos consecutivos além de 1σ (na mesma zona).
5.  **Regra 5:** 6 pontos consecutivos em tendência (crescente ou decrescente).
...
- Navegue pelas abas na parte superior (I-MR, X-Bar R, Sixpack, etc.) para visualizar os gráficos.
- Observe o painel de **Diagnóstico** (ícone `space_dashboard` no canto superior direito) para ver estatísticas detalhadas e interpretação automática.
- Verifique se há pontos vermelhos nos gráficos, indicando violações das regras de controle.
...
Link: [LinkedIn](https://www.linkedin.com/in/thiago-terto-eng-qu%C3%ADmico/)
